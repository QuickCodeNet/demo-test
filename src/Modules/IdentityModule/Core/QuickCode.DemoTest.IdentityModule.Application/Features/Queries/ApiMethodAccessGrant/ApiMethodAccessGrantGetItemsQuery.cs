...
using Humanizer;
using QuickCode.DemoTest.IdentityModule.Application.Dtos;
using QuickCode.DemoTest.IdentityModule.Application.Models;
using QuickCode.DemoTest.IdentityModule.Application.Interfaces.Repositories;
using QuickCode.DemoTest.Common.Helpers;
using QuickCode.DemoTest.Common.Models;

namespace QuickCode.DemoTest.IdentityModule.Api.Application.Features.Queries.ApiMethodAccessGrant
{
