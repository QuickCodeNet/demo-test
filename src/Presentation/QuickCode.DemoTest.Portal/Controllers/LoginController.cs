...
using LoginRequest = QuickCode.DemoTest.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.DemoTest.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.DemoTest.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
