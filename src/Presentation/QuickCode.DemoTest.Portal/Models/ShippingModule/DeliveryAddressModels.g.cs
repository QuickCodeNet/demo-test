...
{
    public class DeliveryAddressData : BaseComboBoxModel
    {
        ...
        public DeliveryAddressDto SelectedItem { get; set; }
        public List<DeliveryAddressDto> List { get; set; }
    }

    public static partial class DeliveryAddressExtensions
    {
        public static string GetKey(this DeliveryAddressDto dto)
        {
            return $"{dto.Id}";
        }
    }
