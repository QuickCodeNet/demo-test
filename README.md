# 🚀 DemoTest - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demo-test.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.DemoTest.Docker.sln
  ```
...
**DemoTest** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
demo-test/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.DemoTest.Gateway/
      QuickCode.DemoTest.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demo-test)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demo-test-gateway.quickcode.net](https://demo-test-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demo-test-portal.quickcode.net](https://demo-test-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demo-test-gateway.quickcode.net](https://demo-test-gateway.quickcode.net)
- **Portal:**
    - link: [https://demo-test-portal.quickcode.net](https://demo-test-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demo-test-identity-module.quickcode.net](https://demo-test-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demo-test-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demo-test-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-02-17 09:48:51 UTC]